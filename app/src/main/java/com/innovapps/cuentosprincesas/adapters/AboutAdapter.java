...
import com.innovapps.cuentosprincesas.models.AboutModel;
...
import static com.innovapps.cuentosprincesas.activities.MainActivity.setting_website;
        ...
        public AboutViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (thePosition == 3) //Privacy Policy and Terms
                    {
                        ...
                        ((FragmentActivity)context).getSupportFragmentManager().beginTransaction()
                                ...
                                .addToBackStack(null)
                                .commit();
                    }else if (thePosition == 6) { //Developer Website
...
//                    }
                    else if (thePosition == 2) { //About Us
                        WebViewFragment webViewFragmentAbout = new WebViewFragment();
                        //Pass variable to fragment
                        Bundle bundle = new Bundle();
...
//                    }
                        ...
                        ((FragmentActivity)context).getSupportFragmentManager().beginTransaction()
                                ...
                                .addToBackStack(null)
                                .commit();
                    }else if (thePosition == 5) { //GDPR Law
                        WebViewFragment webViewFragmentAbout = new WebViewFragment();
                        //Pass variable to fragment
                        Bundle bundle = new Bundle();
