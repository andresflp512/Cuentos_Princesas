package com.innovapps.cuentosprincesas;
...
public class Config {
    ...
    public static final String API_KEY = "Mco5Y6gr4n8hGt5Can12Zqsd3Edz";

    //public static String BASE_URL = "http://192.168.1.109/Projects/MultiContent/";
    //public static String BASE_URL = "http://192.168.1.100:8888/CuentosInfantiles/";
    public static String BASE_URL = "http://full-apps-org.com/Multi/CuentosInfantiles/";
    ...
    public static String PAGE_HELP = BASE_URL + "dashboard/Api/get_one_page/11/";
    ...
    public static String GET_TYPE_CONTENT_AVAILABLE = BASE_URL + "dashboard/Api/type_content_available/";
    public static String GET_CONTENTTYPE_BY_SEARCH_URL = BASE_URL + "dashboard/Api/get_contenttype_by_search/";
    ...
    //firebase topic
    public static String FCM_TOPIC = "CUEN_INF";
    ...
    //dav: nativo ID e Intervalo
    public static String AdMobNativeId = "ca-app-pub-9890110507634929/6819400819";
    ...
    public static String UnixToHuman(String publish_date){
        ...
        sdf.setTimeZone(java.util.TimeZone.getTimeZone("GMT-5:00")); // give a timezone reference for formatting
