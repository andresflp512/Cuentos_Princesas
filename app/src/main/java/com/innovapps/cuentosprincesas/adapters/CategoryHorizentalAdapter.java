...
import com.innovapps.cuentosprincesas.fragments.SubCategoryFragment;
...
public class CategoryHorizentalAdapter extends RecyclerView.Adapter<CategoryHorizentalAdapter.CategoryHorizentalViewHolder>
{
    ...
    public void onBindViewHolder(@NonNull CategoryHorizentalViewHolder holder, int position)
    {
        ...
        switch (i) {
                case 0:
                    holder.bgcolor.setBackgroundColor(context.getResources().getColor(R.color.color_cardview));
                    break;
                case 1:
                    holder.bgcolor.setBackgroundColor(context.getResources().getColor(R.color.color_cardview2));
                    break;
                case 2:
                    holder.bgcolor.setBackgroundColor(context.getResources().getColor(R.color.color_cardview3));
                    break;
                default:
                    break;
            }
