package com.innovapps.cuentosprincesas.fragments;
...
import com.innovapps.cuentosprincesas.activities.MainActivity;
import com.innovapps.cuentosprincesas.utils.Mcallback;
...
import com.innovapps.cuentosprincesas.Config;
import com.innovapps.cuentosprincesas.activities.OneContentDownloadActivity;
import com.innovapps.cuentosprincesas.activities.OneContentLinkActivity;
import com.innovapps.cuentosprincesas.activities.OneContentMusicActivity;
import com.innovapps.cuentosprincesas.activities.OneContentProductActivity;
import com.innovapps.cuentosprincesas.activities.OneContentTextActivity;
import com.innovapps.cuentosprincesas.activities.OneContentVideoActivity;
import com.innovapps.cuentosprincesas.adapters.CategoryHorizentalAdapter;
import com.innovapps.cuentosprincesas.adapters.ContentHorizentalAdapter;
import com.innovapps.cuentosprincesas.models.CategoryModel;
import com.innovapps.cuentosprincesas.models.ContentModel;
import com.innovapps.cuentosprincesas.utils.AppController;
import com.innovapps.cuentosprincesas.utils.Tools;
...
public class MainFragment extends Fragment {
    ...
    AppCompatButton btn_f_main_featured_show_all, btn_f_main_best_rated_show_all, btn_f_main_latest_show_all, btn_f_main_special_show_all;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btn_f_main_featured_show_all = view.findViewById(R.id.btn_f_main_featured_show_all);
        ...
        btn_f_main_best_rated_show_all = view.findViewById(R.id.btn_f_main_best_rated_show_all);
        ...
        //Latest Content List
        btn_f_main_latest_show_all = view.findViewById(R.id.btn_f_main_latest_show_all);
        ...
        btn_f_main_special_show_all = view.findViewById(R.id.btn_f_main_special_show_all);
                        ...
                        textSliderView
                                ...
                                .setOnSliderClickListener(new BaseSliderView.OnSliderClickListener() {
                                    ...
                                    public void onSliderClick(BaseSliderView baseSliderView) {
                                        //dav
                                        ((MainActivity) Objects.requireNonNull(getActivity())).interShow(new Mcallback() {
                                            @Override
                                            public void onAction() {
                                        click = baseSliderView.getBundle().getString("click");
                                        String contentTypeId = click.substring(0,1);
                                        String contentId = click.substring(1);

                                        if(contentTypeId.equals("1")) { //Video
                                        ...
                                        }else if(contentTypeId.equals("3")) { //Game
                                            Intent intent = new Intent(getActivity(), OneContentLinkActivity.class);
                                            intent.putExtra("contentId", contentId); //click has content_id value
                                            intent.putExtra("buttonText", getString(R.string.txt_button_play_game));
                                            startActivity(intent);

                                        }else if(contentTypeId.equals("4")) { //Text
                                        ...
                                        }else if(contentTypeId.equals("5")) { //Download
                                            Intent intent = new Intent(getActivity(), OneContentDownloadActivity.class);
                                            intent.putExtra("contentId", contentId); //click has content_id value
                                            intent.putExtra("buttonText", getString(R.string.txt_button_open));
                                            startActivity(intent);

                                        }else if(contentTypeId.equals("6")) { //Hyperlink
                                            Intent intent = new Intent(getActivity(), OneContentLinkActivity.class);
                                            intent.putExtra("contentId", contentId); //click has content_id value
                                            intent.putExtra("buttonText", getString(R.string.txt_button_open));
                                            startActivity(intent);

                                        }else if(contentTypeId.equals("7")) { //Product and Location
